...
# Valores controlados do chamado. Usamos listas/tuplas como ENUM de negócio
# para evitar textos soltos diferentes no banco e nas telas.
CATEGORIAS_CHAMADO = [
    ("Hardware", "Hardware"),
    ("Software", "Software"),
...
STATUS_CHAMADO = [
    ("aberto", "Aberto / Fila Geral"),
    ("em_andamento", "Em andamento"),
    ("aguardando_cliente", "Aguardando cliente"),
    ("aguardando_reclassificacao", "Aguardando Reclassificação"),
    ("concluido", "Concluído"),
    ("encerrado_adm", "Encerrado por administrador"),
]

def nome_cargo(cargo):
    mapa = dict(CARGOS_USUARIO)
    return mapa.get(cargo or "CLIENTE", "Cliente")


SETORES_PADRAO = [
    "Service Desk / Triagem",
    "Administração",
    "Suporte Técnico",
...
class Usuario(database.Model, UserMixin):
    ...
    # A hierarquia agora é definida apenas pelo campo cargo.

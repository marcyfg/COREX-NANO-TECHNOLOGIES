...
<p>
  ...
  e a excelência digital (Software e Design) de nossos clientes.
</p>
  ...
  <tr>
    <td width="50%">
      ...
      <ul>
        ...
        <li>Instalações de Infraestrutura física</li>
        <li>Configuração de Redes & Servidores</li>
      </ul>
    </td>
    <td width="50%">
